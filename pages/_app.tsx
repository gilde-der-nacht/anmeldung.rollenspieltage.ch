  ...
  return (
    <Layout>
      <>
        ...
        <p>
          Du wirst dein Programm per E-Mail bis am Samstag, 20. August 2022
          erhalten.
        </p>
        <p>
          Solltest du bis zu diesem Zeitpunkt keine E-Mail erhalten haben, dann
          melde dich bitte umgehend bei uns per{" "}
